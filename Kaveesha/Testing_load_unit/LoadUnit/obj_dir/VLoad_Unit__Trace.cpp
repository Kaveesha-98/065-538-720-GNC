...
void VLoad_Unit::traceChgThis__2(VLoad_Unit__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->chgBit(c+25,(vlTOPp->Load_Unit__DOT__count_begin));
        vcdp->chgBit(c+33,(vlTOPp->Load_Unit__DOT__load_begin));
        vcdp->chgBus(c+41,(vlTOPp->Load_Unit__DOT__cntReg),2);
        vcdp->chgBit(c+49,(vlTOPp->Load_Unit__DOT__reading));
        vcdp->chgBit(c+57,(vlTOPp->Load_Unit__DOT__loading));
        vcdp->chgBit(c+65,(vlTOPp->Load_Unit__DOT__stateReg));
    }
}
...
void VLoad_Unit::traceChgThis__3(VLoad_Unit__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->chgBus(c+89,(vlTOPp->io_load_mem_address_in),32);
        vcdp->chgBus(c+97,(vlTOPp->io_load_data),8);
        vcdp->chgBit(c+105,(vlTOPp->io_LOAD_TO_REG));
        vcdp->chgBus(c+113,(vlTOPp->io_LOAD_SIZE),2);
        vcdp->chgBit(c+121,(vlTOPp->io_LOAD_ADDRESS_IN));
        vcdp->chgBit(c+129,(vlTOPp->io_mem_read));
        vcdp->chgBit(c+137,(vlTOPp->io_LOAD_READY));
        vcdp->chgBus(c+145,(vlTOPp->io_load_mem_address_out),32);
