...
void Vdata_path::traceChg(VerilatedVcd* vcdp, void* userthis, uint32_t code) {
...
void Vdata_path::traceChgThis(Vdata_path__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
...
void Vdata_path::traceChgThis__2(Vdata_path__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    Vdata_path* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    int c = code;
    if (0 && vcdp && c) {}  // Prevent unused
    // Body
...
void Vdata_path::traceChgThis__3(Vdata_path__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    Vdata_path* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    int c = code;
    if (0 && vcdp && c) {}  // Prevent unused
    // Body
...
void Vdata_path::traceChgThis__4(Vdata_path__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    Vdata_path* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    int c = code;
    if (0 && vcdp && c) {}  // Prevent unused
    // Body
