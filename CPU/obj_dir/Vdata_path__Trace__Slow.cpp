...
void Vdata_path::trace(VerilatedVcdC* tfp, int, int) {
    tfp->spTrace()->addCallback(&Vdata_path::traceInit, &Vdata_path::traceFull, &Vdata_path::traceChg, this);
}
void Vdata_path::traceInit(VerilatedVcd* vcdp, void* userthis, uint32_t code) {
    // Callback from vcd->open()
    Vdata_path* t = (Vdata_path*)userthis;
    Vdata_path__Syms* __restrict vlSymsp = t->__VlSymsp;  // Setup global symbol table
...
void Vdata_path::traceFull(VerilatedVcd* vcdp, void* userthis, uint32_t code) {
...
void Vdata_path::traceInitThis(Vdata_path__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
...
void Vdata_path::traceFullThis(Vdata_path__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    Vdata_path* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    int c = code;
    if (0 && vcdp && c) {}  // Prevent unused
    // Body
...
void Vdata_path::traceInitThis__1(Vdata_path__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    Vdata_path* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    int c = code;
    if (0 && vcdp && c) {}  // Prevent unused
    // Body
...
void Vdata_path::traceFullThis__1(Vdata_path__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    Vdata_path* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    int c = code;
    if (0 && vcdp && c) {}  // Prevent unused
    // Body
