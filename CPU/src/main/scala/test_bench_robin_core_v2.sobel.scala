...
class test_bench_robin_core_v2_sobel extends Module{
	...
	val robinCore = Module(new robin_core_v2_sobel())
...
object test_bench_robin_core_v2_sobel extends App{
    (new chisel3.stage.ChiselStage).emitVerilog(new test_bench_robin_core_v2_sobel)
}
